...
class ApiKeysControllerTest < ActionController::TestCase
  ...
  test "should create api_key" do
    assert_difference('ApiKey.count') do
      post :create, api_key: { acc_system_id: @api_key.acc_system_id, key: @api_key.key, name: @api_key.name }
    end
  ...
  test "should update api_key" do
    patch :update, id: @api_key, api_key: { acc_system_id: @api_key.acc_system_id, key: @api_key.key, name: @api_key.name }
    assert_redirected_to api_key_path(assigns(:api_key))
  end
